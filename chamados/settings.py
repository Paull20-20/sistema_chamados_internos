...
SECRET_KEY = 'django-insecure-v2zfht&i(yv=q87))i=ww2+s=cw@i%&%^0832t-gyj%6x+6h3d'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['https://frozen-oasis-69936.herokuapp.com/'] #url que tem acesso ao projeto
